# 深度技术分析：Nemotron-Labs-3-Puzzle-75B-A9B: Compressing Hybrid MoE LLMs

> 本分析基于 arXiv 摘要与论文公开信息撰写，所有数字均引自摘要。

## 1. 核心速览

**研究主题**：量化方向（技术标签：量化、剪枝、知识蒸馏）；论文分类：cs.AI

**一句话总结**：本文提出 Nemotron-Labs-3-Puzzle-75B-A9B，面向量化场景解决模型存储/计算成本与精度之间的权衡问题。
...
- We present Nemotron-Labs-3-Puzzle-75B-A9B, a compressed variant of Nemotron-3-Super optimized for interactive deployment.
...
- We present Nemotron-Labs-3-Puzzle-75B-A9B, a compressed variant of Nemotron-3-Super optimized for interactive deployment.
- We designed the model to maximize server throughput under high user throughput constraints.
...
2. 通过量化指标验证了方法有效性（摘要报告的关键数字包括：2x, 75B, 9B 等）；
...
**实验模型**：Nemotron-3-Super, Nemotron-Labs-3-Puzzle-75B-A9B
...
- We evaluate Puzzle-75B-A9B on a broad suite of reasoning, coding, multilingual, long-context, and agentic benchmarks.
- Despite substantial compression, the model retains strong downstream accuracy relative to the parent model across a wide range of tasks.
...
*论文信息：arXiv:2607.04371，Akhiad Bercovich, Talor Abramovich, Daniel Afrimi, Shay Aharon, Nir Ailon 等，提交日期 2026-07-05，链接 https://arxiv.org/abs/2607.04371*