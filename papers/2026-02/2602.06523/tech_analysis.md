# 深度技术分析：MicroBi-ConvLSTM: An Ultra-Lightweight Efficient Model for Human Activity Recognition on Resource Constrained Devices

> **论文信息**
> - **arXiv ID**: 2602.06523
> - **标题**: MicroBi-ConvLSTM: An Ultra-Lightweight Efficient Model for Human Activity Recognition on Resource Constrained Devices
> - **作者**: Mridankan Mandal
> - **提交日期**: 2026-02-06
> - **分类**: cs.CV, cs.HC
...
本文属于**量化（Quantization）、硬件加速/软硬件协同、高效架构设计**方向的研究，提出了名为 **MicroBi-ConvLSTM** 的方法。

> 论文摘要首句：*"Human Activity Recognition (HAR) on resource constrained wearables requires models that balance accuracy against strict memory and computational budgets."*

### 1.2 一句话总结

本文提出 MicroBi-ConvLSTM：We present MicroBi-ConvLSTM, an ultra-lightweight convolutional recurrent architecture achieving 11.4K parameters on average through two stage convolutional feature extraction with 4x temporal pooling, and a single bidirectional LSTM layer.（摘要原文）
...
- *"Human Activity Recognition (HAR) on resource constrained wearables requires models that balance accuracy against strict memory and computational budgets."*
...
1. 提出了可命名的新方法/框架 **MicroBi-ConvLSTM**，属于量化（Quantization）、硬件加速/软硬件协同、高效架构设计方向的新方案；
