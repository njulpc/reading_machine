# 深度技术分析：Rethinking Selective Knowledge Distillation
...
> - **提交日期**: 2026-02-01
> - **分类**: cs.CL
> - **链接**: https://arxiv.org/abs/2602.01395
...
> 论文摘要首句：*"Growing efforts to improve knowledge distillation (KD) in large language models (LLMs) replace dense teacher supervision with selective distillation, which uses a subset of token positions, vocabulary classes, or training samples for supervision."*

### 1.2 一句话总结

本文Then, guided by this analysis, we identify underexplored opportunities and introduce student-entropy-guided position selection (SE-KD).（摘要原文）
...
- *"In this work, we revisit where and how to distill in autoregressive LLMs."*
- *"We disentangle selective KD along the position, class, and sample axes and systematically compare importance signals and selection policies."*
...
- *"Then, guided by this analysis, we identify underexplored opportunities and introduce student-entropy-guided position selection (SE-KD)."*
