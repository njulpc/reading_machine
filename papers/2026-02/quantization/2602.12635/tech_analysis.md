# 深度技术分析：Unleashing Low-Bit Inference on Ascend NPUs: A Comprehensive Evaluation of HiFloat Formats

> **论文信息**
> - **arXiv ID**: 2602.12635
> - **标题**: Unleashing Low-Bit Inference on Ascend NPUs: A Comprehensive Evaluation of HiFloat Formats
> - **作者**: Pengxiang Zhao, Hui-Ling Zhen, Xing Li, Han Bao, Weizhe Lin, Zhiyuan Yang 等
> - **提交日期**: 2026-02-13
...
本文属于**量化（Quantization）、KV Cache 压缩**方向的研究，提出了名为 **NPUs** 的方法。

> 论文摘要首句：*"As LLMs scale, low-bit floating-point formats like MXFP and NVFP4 offer new opportunities for precision and efficiency."*

### 1.2 一句话总结

本文提出 NPUs：In this work, we evaluate HiFloat (HiF8 and HiF4), a family of formats tailored for Ascend NPUs.（摘要原文）
...
- *"In this work, we evaluate HiFloat (HiF8 and HiF4), a family of formats tailored for Ascend NPUs."*
...
- *"Overall, HiFloat provides a solution for high-efficiency LLM inference on NPUs."*
