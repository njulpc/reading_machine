# 深度技术分析：jina-embeddings-v5-text: Task-Targeted Embedding Distillation

> **论文信息**
> - **arXiv ID**: 2602.15547
> - **标题**: jina-embeddings-v5-text: Task-Targeted Embedding Distillation
> - **作者**: Mohammad Kalim Akram, Saba Sturua, Nastia Havriushenko, Q. Herreros, Michael Günther, Maximilian Werk 等
> - **提交日期**: 2026-02-17
> - **分类**: cs.CL
...
> 论文摘要首句：*"Text embedding models are widely used for semantic similarity tasks, including information retrieval, clustering, and classification."*

### 1.2 一句话总结

本文We introduce a novel training regimen that combines model distillation techniques with task-specific contrastive loss to produce compact, high-performance embedding models.（摘要原文）
