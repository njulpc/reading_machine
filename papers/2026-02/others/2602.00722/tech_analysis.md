# 深度技术分析：Spectral Imbalance Causes Forgetting in Low-Rank Continual Adaptation

> **论文信息**
> - **arXiv ID**: 2602.00722
> - **标题**: Spectral Imbalance Causes Forgetting in Low-Rank Continual Adaptation
> - **作者**: Hao Gu, Mao-Lin Luo, Zi-Hao Zhou, Han-Chen Zhang, Min-Ling Zhang, Tong Wei
> - **提交日期**: 31 Jan 2026 (v1), last revised 2 Jul 2026 (this version, v2)
> - **分类**: cs.LG
...
> 论文摘要首句：*"Parameter-efficient continual learning aims to adapt pre-trained models to sequential tasks without forgetting previously acquired knowledge."*

### 1.2 一句话总结

本文Our method mitigates both backward and forward forgetting, consistently outperforming continual learning baselines.（摘要原文）
...
- *"Parameter-efficient continual learning aims to adapt pre-trained models to sequential tasks without forgetting previously acquired knowledge."*
- *"Most existing approaches treat continual learning as avoiding interference with past updates, rather than considering what properties make the current task-specific update naturally preserve previously acquired knowledge."*
...
- *"Our method mitigates both backward and forward forgetting, consistently outperforming continual learning baselines."*
