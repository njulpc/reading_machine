# 深度技术分析：Efficient Cross-Architecture Knowledge Transfer for Large-Scale Online User Response Prediction

> **论文信息**
> - **arXiv ID**: 2602.01775
> - **标题**: Efficient Cross-Architecture Knowledge Transfer for Large-Scale Online User Response Prediction
> - **作者**: Yucheng Wu, Yuekui Yang, Hongzheng Li, Anan Liu, Jian Xiao, Junjie Zhai 等
> - **提交日期**: 2026-02-02
> - **分类**: cs.AI, cs.LG
...
> 论文摘要首句：*"Deploying new architectures in large-scale user response prediction systems incurs high model switching costs due to expensive retraining on massive historical data and performance degradation under data retention constraints."*

### 1.2 一句话总结

本文We propose CrossAdapt, a two-stage framework for efficient cross-architecture knowledge transfer.（摘要原文）
...
- *"Deploying new architectures in large-scale user response prediction systems incurs high model switching costs due to expensive retraining on massive historical data and performance degradation under data retention constraints."*
