# 深度技术分析：A Scaling Law for Bandwidth Under Quantization

> **论文信息**
> - **arXiv ID**: 2602.23252
> - **标题**: A Scaling Law for Bandwidth Under Quantization
> - **作者**: Maximilian Kalcher, Tena Dubcek
> - **提交日期**: 2026-02-26
> - **分类**: —
> - **链接**: https://arxiv.org/abs/2602.23252
...
> 论文摘要首句：*"We derive a scaling law relating ADC bit depth to effective bandwidth for signals with $1/f^α$ power spectra."*

### 1.2 一句话总结

本文We derive a scaling law relating ADC bit depth to effective bandwidth for signals with $1/f^α$ power spectra.（摘要原文）
...
- *"Quantization introduces a flat noise floor whose intersection with the declining signal spectrum defines an effective cutoff frequency $f_c$."*
...
- *"The law requires that quantization noise be approximately white, a condition whose minimum bit depth $N_{\min}$ we show to be $α$-dependent."*
