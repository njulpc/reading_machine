# 深度技术分析：Multi-Token Prediction via Self-Distillation
...
> - **提交日期**: 5 Feb 2026 (v1), last revised 23 Apr 2026 (this version, v2)
> - **分类**: cs.CL, cs.LG
...
本文属于**知识蒸馏（Knowledge Distillation）、高效架构设计**方向的研究，在 GSM8K 等基准上进行了验证。

> 论文摘要首句：*"Existing techniques for accelerating language model inference, such as speculative decoding, require training auxiliary speculator models and building and deploying complex inference pipelines."*

### 1.2 一句话总结

本文Our method produces models that decode more than $3\times$ faster at $<5\%$ drop in accuracy on GSM8K relative to the single token decoding performance of the same checkpoint.（摘要原文）
