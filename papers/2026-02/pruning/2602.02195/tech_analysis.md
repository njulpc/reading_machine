...
本文属于**KV Cache 压缩、剪枝（Pruning）、低秩分解/低秩适应（Low-Rank）**方向的研究。
...
本文In this work, we present a comprehensive study on the runtime state dynamics of state-of-the-art Linear Attention models.（摘要原文）
