# 深度技术分析：COMET: Codebook-based Online-adaptive Multi-scale Embedding for Time-series Anomaly Detection

> **论文信息**
> - **arXiv ID**: 2602.01635
> - **标题**: COMET: Codebook-based Online-adaptive Multi-scale Embedding for Time-series Anomaly Detection
...
- *"Time series anomaly detection is a critical task across various industrial domains."*
...
- *"Furthermore, focusing on normal data representations makes models vulnerable to distribution shifts at inference time."*
