# 深度技术分析：Efficient Analysis of the Distilled Neural Tangent Kernel

> **论文信息**
> - **arXiv ID**: 2602.11320
> - **标题**: Efficient Analysis of the Distilled Neural Tangent Kernel
> - **作者**: Jamie Mahowald, Brian Bell, Alex Ho, Michael Geyer
> - **提交日期**: 11 Feb 2026 (v1), last revised 17 Feb 2026 (this version, v2)
> - **分类**: cs.LG
...
> 论文摘要首句：*"Neural tangent kernel (NTK) methods are computationally limited by the need to evaluate large Jacobians across many data points."*

### 1.2 一句话总结

本文We show that NTK computation can also be reduced by compressing the data dimension itself using NTK-tuned dataset distillation.（摘要原文）
...
- *"Neural tangent kernel (NTK) methods are computationally limited by the need to evaluate large Jacobians across many data points."*
- *"Existing approaches reduce this cost primarily through projecting and sketching the Jacobian."*
- *"We show that NTK computation can also be reduced by compressing the data dimension itself using NTK-tuned dataset distillation."*
