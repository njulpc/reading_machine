# 深度技术分析：The Gaussian-Head OFL Family: One-Shot Federated Learning from Client Global Statistics

> **论文信息**
> - **arXiv ID**: 2602.01186
> - **标题**: The Gaussian-Head OFL Family: One-Shot Federated Learning from Client Global Statistics
...
- *"Classical Federated Learning relies on a multi-round iterative process of model exchange and aggregation between server and clients, with high communication costs and privacy risks from repeated model transmissions."*
