# 深度技术分析：BCJR-QAT: A Differentiable Relaxation of Trellis-Coded Weight Quantization

## 1. 核心速览
**研究话题**：量化 (Quantization)、知识蒸馏 (Knowledge Distillation)，目标对象为神经网络

**一句话总结**：We introduce BCJR-QAT, a relaxation that replaces the argmax with the BCJR forward-backward sum-product algorithm at temperature $T$, producing a soft codeword equal to the Boltzmann expectation over trellis paths, exactly differentiable, recovering the hard QTIP code as $T \to 0$, and mathematically identical to the transfer-matrix computation for a 1D Ising-like spin chain。

**方法名称**：BCJR-QAT（论文提出的核心方法/系统）
...
*论文信息：arXiv:2605.10655，Venugopalan Iyengar，提交于 2026-05-11，分类：cs.LG，https://arxiv.org/abs/2605.10655*
