# 深度技术分析：Asymmetric Generative Recommendation via Multi-Expert Projection and Multi-Faceted Hierarchical Quantization

## 1. 核心速览
**研究话题**：量化 (Quantization)、向量量化 (Vector Quantization)，目标对象为推荐系统

**一句话总结**：To address these issues, we propose AsymRec, an asymmetric continuous-discrete framework that decouples input and output representations。
...
- Extensive experiments demonstrate that AsymRec consistently outperforms state-of-the-art generative recommenders by an average of 15.8 %.
...
*论文信息：arXiv:2605.14512，Bin Huang, Xin Wang, Junwei Pan, Yongqi Zhou, Yifeng Zhou, Zhixiang Feng 等，提交于 2026-05-14，分类：cs.IR, cs.AI，https://arxiv.org/abs/2605.14512*
