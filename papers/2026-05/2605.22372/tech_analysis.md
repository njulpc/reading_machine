# 深度技术分析：ASAP: Attention Sink Anchored Pruning

## 1. 核心速览
**研究话题**：剪枝 (Pruning)，目标对象为视觉语言模型

**一句话总结**：We propose ASAP (Attention Sink Anchored Pruning), a training-free framework that recasts this sink as a feature。

**方法名称**：ASAP（论文提出的核心方法/系统）
...
- **要点1**：We propose ASAP (Attention Sink Anchored Pruning), a training-free framework that recasts this sink as a feature.
...
- Extensive experiments across image, video, and vision-language tasks demonstrate ASAP outperforms state-of-the-art methods, accelerating throughput by up to 48% while maintaining - or even exceeding - baseline accuracy.
...
*论文信息：arXiv:2605.22372，Jaehyuk Lee, Hanyoung Kim, Yanggee Kim, Donghun Lee，提交于 2026-05-21，分类：cs.LG，https://arxiv.org/abs/2605.22372*
