...
def main():
 ...
 r=run_full('nvfp4',harmonize_groups=True);r.update({'weight_block':16,'activation_block':16,'scale_format':'E4M3 plus FP32 global','harmonization_test':'PASS on real Qwen QKV and gate/up groups','boundary':'No GDN in Qwen3-0.6B; no 27B/32K experiments or native FP4 GEMM. Static globals calibrated on four local texts, not paper 128x32K. FP8 KV calibration not integrated.'});save(r,a.output_json)
